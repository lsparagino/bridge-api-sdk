...
class GetCustomersCustomerIDLiquidationAddressesLiquidationAddressIDDrainsRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $customerID, string $liquidationAddressID, ?int $limit = null, ?string $startingAfter = null, ?string $endingBefore = null, ?int $updatedAfterMs = null, ?int $updatedBeforeMs = null)
    {
