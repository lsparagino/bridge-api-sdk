...
class GetTransfersRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?int $limit = null, ?string $startingAfter = null, ?string $endingBefore = null, ?string $txHash = null, ?int $updatedAfterMs = null, ?int $updatedBeforeMs = null, ?string $templateId = null, ?Components\TransferStateParameter $state = null)
    {
        $this->limit = $limit;
