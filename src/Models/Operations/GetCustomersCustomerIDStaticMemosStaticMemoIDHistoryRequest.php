...
class GetCustomersCustomerIDStaticMemosStaticMemoIDHistoryRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $customerID, string $staticMemoID, ?string $depositId = null, ?array $depositIds = null, ?string $txHash = null, ?int $limit = null, ?string $startingAfter = null, ?string $endingBefore = null, ?Components\EventTypeParameter $eventType = null)
    {
