...
class GetCustomersCustomerIDVirtualAccountsVirtualAccountIDHistoryRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $customerID, string $virtualAccountID, ?string $depositId = null, ?array $depositIds = null, ?string $txHash = null, ?int $limit = null, ?string $startingAfter = null, ?string $endingBefore = null, ?Components\EventTypeParameter $eventType = null)
    {
