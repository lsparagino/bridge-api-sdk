...
class GetStaticMemosRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?Components\VirtualAccountActivationStatus $status = null, ?int $limit = null, ?string $startingAfter = null, ?string $endingBefore = null)
    {
        $this->status = $status;
        $this->limit = $limit;
