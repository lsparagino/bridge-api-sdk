...
class ExternalAccountAddress
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $streetLine1, string $city, string $country, ?string $streetLine2 = null, ?string $state = null, ?string $postalCode = null)
    {
