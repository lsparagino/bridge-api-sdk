...
use ReThink\BridgeSDK\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.1.1 2.797.1 1 rethink/bridgesdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(BridgeSDK::SERVERS[$this->serverIndex])) {
            return BridgeSDK::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(BridgeSDK::SERVERS[$this->serverIndex], []);
